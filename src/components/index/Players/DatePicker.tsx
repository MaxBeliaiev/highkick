...
export const Players_Dummy_Data: IPlayersData[] = [
  {
    value1: "75%",
    value2: "50%",
    icon: <CrownIcon className="w-[32px] text-[#E81068]" />,
    heading: "Win Rate",
  },
  {
    value1: "75%",
  ...
  return (
    <div className="flex w-[350px] flex-col items-center gap-[50px] xmd:mx-auto sm:max-w-[350px] sm:gap-[20px]">
              ...
              <DropdownMenuContent className="flex w-[350px] flex-col gap-[6px] border-none shadow-none sm:max-w-[350px]">
                  ...
                  <Popover modal={false}>
                    ...
                    >
                      <Calendar
                        ...
                        toDate={dateTo ? dateTo : new Date()}
                        className="w-[350px] rounded-[8px] bg-[#FFF] sm:max-w-[350px]"
                        mode="single"
                        selected={dateFrom}
                        onSelect={(e) => e && setDateFrom(e)}
                      />
                    </PopoverContent>
                  </Popover>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem className="w-full" asChild>
                  <Popover modal={false}>
                    ...
                    >
                      <Calendar
                        fromDate={dateFrom ? dateFrom : new Date("2023-01-01")}
                        toDate={new Date()}
                        className="w-[350px] rounded-[8px] bg-[#FFF] sm:max-w-[350px]"
                        mode="single"
                        selected={dateTo}
                        onSelect={(e) => e && setDateTo(e)}
                      />
                    </PopoverContent>
                  </Popover>
                </DropdownMenuItem>
      ...
      <Table className="m-0 w-full p-0 text-[22px] sm:text-[16px] ">
        <TableBody>
          {Players_Dummy_Data?.map((data, index) => (
            <TableRow key={index} className="w-full border-none">
              <TableCell className="pl-0">{data.value1}</TableCell>
              ...
              <TableCell className="pr-0 ">{data.value2}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
