...
export function LiveNow({ data }: { data: ILiveData[] }) {
  return (
    <section className="container mx-auto flex w-full flex-col gap-[50px] pb-[70px] pt-[40px] sm:gap-[30px] sm:pb-[40px] sm:pt-[20px]">
      {data?.map((live: ILiveData, index) => (
        ...
        >
          <div className="flex h-[670px] w-full lg:h-[550px] xmd:h-[450px] md:h-[350px] sm:h-[300px]">
            ...
            <Link href={live.href} className="w-full bg-[#000]"></Link>
